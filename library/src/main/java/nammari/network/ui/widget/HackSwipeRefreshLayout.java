...
/**
 * Created by nammari on 8/18/14.
 */
public class HackSwipeRefreshLayout extends ViewGroup {
 ...
 */
    ...
    private final Animation mAnimateToStartPosition = new Animation() {
        ...
        public void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            //Log.e("applyTransoframtion","applyTransoframtion");
    ...
    public final Runnable mReturnToStartPosition = new Runnable() {

        @Override
        public void run() {
            mReturningToStart = true;
            //Log.e("mReturnToStartPosition","from mReturnToStartPosition");
    ...
    public final Runnable mCancel = new Runnable() {
